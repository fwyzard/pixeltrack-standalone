...
public:
  ...
  explicit SiPixelDigisCUDA(size_t maxFedWords, CUstream stream);
  ~SiPixelDigisCUDA() = default;
  ...
  cms::cuda::host::unique_ptr<uint16_t[]> adcToHostAsync(CUstream stream) const;
  cms::cuda::host::unique_ptr<int32_t[]> clusToHostAsync(CUstream stream) const;
  cms::cuda::host::unique_ptr<uint32_t[]> pdigiToHostAsync(CUstream stream) const;
  cms::cuda::host::unique_ptr<uint32_t[]> rawIdArrToHostAsync(CUstream stream) const;
