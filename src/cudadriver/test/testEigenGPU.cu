...
void testFit() {
  ...
  cuteCheck(cuMemAlloc((CUdeviceptr*)&hitsGPU, Rfit::maxNumberOfTracks() * sizeof(Rfit::Matrix3xNd<N>)));
  cuteCheck(cuMemAlloc((CUdeviceptr*)&hits_geGPU, Rfit::maxNumberOfTracks() * sizeof(Rfit::Matrix6xNf<N>)));
  cuteCheck(cuMemAlloc((CUdeviceptr*)&fast_fit_resultsGPU, Rfit::maxNumberOfTracks() * sizeof(Vector4d)));
  cuteCheck(cuMemAlloc((CUdeviceptr*)&line_fit_resultsGPU, Rfit::maxNumberOfTracks() * sizeof(Rfit::line_fit)));
  cuteCheck(cuMemAlloc((CUdeviceptr*)&circle_fit_resultsGPU, Rfit::maxNumberOfTracks() * sizeof(Rfit::circle_fit)));

  cuteCheck(cuMemsetD8((CUdeviceptr) fast_fit_resultsGPU, 0x00, Rfit::maxNumberOfTracks() * sizeof(Vector4d)));
  cuteCheck(cuMemsetD8((CUdeviceptr) line_fit_resultsGPU, 0x00, Rfit::maxNumberOfTracks() * sizeof(Rfit::line_fit)));
  ...
  cuteCheck(cuMemcpyDtoH(
      (void*)fast_fit_resultsGPUret, (CUdeviceptr)fast_fit_resultsGPU, Rfit::maxNumberOfTracks() * sizeof(Vector4d)));
  ...
  cuteCheck(
      cuMemcpy((CUdeviceptr)circle_fit_resultsGPUret, (CUdeviceptr)circle_fit_resultsGPU, sizeof(Rfit::circle_fit)));
  ...
  // LINE_FIT GPU
  cuteCheck(cuMemcpy((CUdeviceptr)line_fit_resultsGPUret, (CUdeviceptr)line_fit_resultsGPU, sizeof(Rfit::line_fit)));
