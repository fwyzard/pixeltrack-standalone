...
#ifdef __CUDACC__
  float* p_d;
  cuteCheck(cuMemAlloc((CUdeviceptr*)&p_d, 1024 * 4));
  cuteCheck(cuMemcpy((CUdeviceptr)p_d, (CUdeviceptr)p, 1024 * 4));
  testBasicSoA<<<1, 1024>>>(p_d);
  cuteCheck(cuMemcpy((CUdeviceptr)p, (CUdeviceptr)p_d, 1024 * 4));
